        ...
        formattedMatches = await Promise.all(fixtures.map(async (fixture) => {
            ...
            if (matchResult && matchResult.completed) {
                ...
                return {
                    ...
                    team1Flag: `/path/to/flags/${fixture.team_h}.png`,
                    team2Flag: `/path/to/flags/${fixture.team_a}.png`,
                ...
                return {
                    ...
                    team1: teamMapping[fixture.team_h],
                    team2: teamMapping[fixture.team_a],
                    team1Flag: `../badges/${fixture.team_h}.png`,
                    team2Flag: `../badges/${fixture.team_h}.png`,
                    team1Score: null,
                    team2Score: null,
                    finished: fixture.finished,
